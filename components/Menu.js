  ...
  render(){
    return(
      <div id="menu" style={{height: "100%", width: "100%", marginTop: "10vh", textAlign: "center"}}>
        ...
        <div className="menuCategory" style={showMenu(this.state.showSandwiches, 0)}>
          ...
          <div style={{fontFamily: "menco, sans-serif"}}>
            ...
            <p>Veggie w/ Pimiento Cheese</p>
            <p>Cauliflower Grilled Cheese w/ Sun-Dried Tomatoes</p>
          </div>

        </div>

        <div className="menuCategory" style={showMenu(this.state.showSoups, 0.25)}>
          ...
          <div style={{fontFamily: "menco, sans-serif"}}>
            ...
            <p>Home Chicken Noodle Soup</p>
            <p>Minestrone with Parmigiano-Reggiano</p>
          </div>

        </div>

        <div className="menuCategory" style={showMenu(this.state.showFruits, .5)}>
          ...
          <div style={{fontFamily: "menco, sans-serif"}}>
            ...
            <p>PB&J Smoothie</p>
            <p>'Nana Ginger Smoothie</p>
            <p>Orange Dream Smoothie</p>
            <p>Mixed Berry Fruit Cup or Bowl</p>
            <p>Cara-Apple Overnight Oatmeal Smoothie</p>
          </div>

        </div>

        <div className="menuCategory" style={showMenu(this.state.showDrinks, .75)}>
        ...
        <div className="showPics" style={{fontFamily: "gelo, serif", fontSize: ".95em", width: "50%", minWidth: "250px", height: "10vh", backgroundColor: "#6FA16F", color: "white", textAlign: "center", margin: "0 auto", padding: "2vh .5em", borderRadius: ".5em", cursor: "pointer", transition: ".5s"}}>
          <h2 style={{marginBottom: "0", paddingBottom: ".2em"}}>Click to view gallery</h2>
