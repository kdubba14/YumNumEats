...
const App = () => { 
  ...
  return (
    ...
    <div style={{backgroundColor: "#FFF9E7", height: "100%", width: "100%"}}>
      ...
      <Container>
        <div id="about-us" style={{minHeight: "60vh", width: "70%", padding: "0 15%", margin: "10vh 0", textAlign: "center"}}>

          <h1 style={{margin: "0", padding: "5% 0 5% 0", fontFamily: "gelo, serif"}}>ABOUT US</h1>
